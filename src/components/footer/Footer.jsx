    ...
    <section className="footerSection">
      ...
      <div className="footerStrip">
        ...
        <div className="commFtr">
          <a href="tel:9057770955">
            <div className="ftrPhoneButton">
              <FaMobile className="ftrMobileLogo" />
              <p>90577-70955</p>
            </div>
          </a>
          <a href="https://wa.me/+919057770955" target="_blank">
            <FaSquareWhatsapp className="ftrWhatsappLogo" />
          </a>
          <a href="https://www.instagram.com/legalyodha.in" target="_blank">
            <FaInstagram className="ftrInstaLogo" />
          </a>
          {/* <a href="https://wa.me/+919057770955" target="_blank">
            <FaLinkedin className="ftrLinkedLogo" />
          </a> */}
          <a href="https://www.facebook.com/profile.php?id=61558871204556&mibextid=LQQJ4d" target="_blank">
            <FaFacebookSquare className="ftrFBLogo" />
          </a>
